...
import { sportybet } from "@/constants";
import { Metadata } from "next";
import { useTranslations } from "next-intl";

export const metadata: Metadata = {
  title: sportybet.title,
  description: sportybet.description,
  keywords: sportybet.keywords,
};
  ...
  return (
    <>
      ...
      <div className="py-10 mt-8 mb-10 px-4 lg:px-20 md:px-10 flex flex-col items-center">
        ...
        <AccumulatorBuilderForm bookie={"sportybet"} />
