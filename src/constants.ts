...
export const specificLeagueSeoText: TLeagueSeoText = {
  ...
  "ligue-1": ligue1Content,
  "england-premier-league": englandPremierLeagueContent,
  bundesliga: bundesligaContent,
};
...
export const paramsSeoText: Record<TParams, string> = {
  ...
  soccereco: soccerecoContent,
  soccervital: soccervitalContent,
  forebet: forebetContent,
  olbg: olbgContent,
  adibet: adibetContent,
  zulubet: zulubetContent,
  betwizad: betwizadContent,
  focuspredict: focuspredictContent,
  kingspredict: kingspredictContent,
  tips180: tips180Content,
  legitpredict: legitpredictContent,
  solopredict: solopredictContent,
...
export const fonbnkDetails = {
  source: process.env.NEXT_PUBLIC_FONBNK_SOURCE ?? "ysIzEXl5",
  network: process.env.NEXT_PUBLIC_FONBNK_NETWORK ?? "TRON",
